...
WebUI.setText(findTestObject('Object Repository/data-qa', [('data-qa') : 'login-email']), email)
WebUI.setText(findTestObject('Object Repository/data-qa', [('data-qa') : 'login-password']), password)
