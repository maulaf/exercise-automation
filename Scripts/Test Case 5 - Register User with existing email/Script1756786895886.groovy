...
WebUI.setText(findTestObject('Object Repository/data-qa', [('data-qa') : 'signup-name']), name)
...
WebUI.verifyElementVisible(findTestObject('Object Repository/text', [('text') : 'Email Address already exist!']))